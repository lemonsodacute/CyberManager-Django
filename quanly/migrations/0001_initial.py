...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='KhachHang',
            fields=[
                ('tai_khoan', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='khachhang', serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chu_ky_lap_lai', models.CharField(choices=[('MOT_LAN', 'Áp dụng một lần (theo ngày bắt đầu/kết thúc)'), ('HANG_NGAY', 'Lặp lại Hằng ngày'), ('HANG_TUAN', 'Lặp lại Hàng tuần'), ('HANG_THANG', 'Lặp lại Hàng tháng')], default='MOT_LAN', max_length=20, verbose_name='Chu kỳ lặp lại')),
                ('ngay_trong_tuan', models.CharField(blank=True, max_length=15, null=True, verbose_name='Các ngày trong tuần')),
            ],
        ),
        migrations.CreateModel(
            name='LoaiCa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('don_gia_gio', models.DecimalField(decimal_places=2, max_digits=10)),
            ],
        ),
        migrations.CreateModel(
            name='NguyenLieu',
            fields=[
                ...
                ('gia_von', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Giá vốn / Đơn vị')),
            ],
        ),
        migrations.CreateModel(
            name='NhanVien',
            fields=[
                ('tai_khoan', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='nhanvien', serialize=False, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='DonHangDichVu',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('loai_giao_dich', models.CharField(choices=[('NAP_TIEN', 'Nạp tiền vào tài khoản thành viên'), ('THANH_TOAN_HOA_DON', 'Thanh toán hóa đơn (Tiền mặt/Chuyển khoản)'), ('THANH_TOAN_ORDER_LE', 'Thanh toán order lẻ (Tiền mặt/Chuyển khoản)'), ('THANH_TOAN_TK', 'Thanh toán hóa đơn (Trừ vào tài khoản)'), ('ADMIN_ADJUST', 'Admin điều chỉnh')], max_length=30, verbose_name='Loại giao dịch')),
                ('so_tien', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Số tiền')),
                ('thoi_gian_giao_dich', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Thời gian giao dịch')),
                ('ghi_chu', models.CharField(blank=True, max_length=255, null=True, verbose_name='Ghi chú')),
                ('ca_lam_viec', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cac_giao_dich', to='quanly.calamviec', verbose_name='Ca làm việc')),
                ('don_hang_le', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='giao_dich', to='quanly.donhangdichvu', verbose_name='Đơn hàng lẻ')),
                ('hoa_don', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cac_giao_dich', to='quanly.hoadon', verbose_name='Hóa đơn')),
                ('khach_hang', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='quanly.khachhang', verbose_name='Khách hàng')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trang_thai', models.CharField(choices=[('TRONG', 'Trống'), ('DANG_SU_DUNG', 'Đang sử dụng'), ('HONG', 'Hỏng')], default='TRONG', max_length=20)),
                ('loai_may', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='quanly.loaimay')),
            ],
        ),
        migrations.CreateModel(
            name='MenuItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ca_lam_viec', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cac_thay_doi_kho', to='quanly.calamviec')),
                ('nguyen_lieu', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='quanly.nguyenlieu')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loai_canh_bao', models.CharField(choices=[('KHO', 'Cảnh báo Tồn kho'), ('TIEN', 'Cảnh báo Tiền mặt/Chênh lệch'), ('HE_THONG', 'Cảnh báo Hệ thống/Vận hành')], default='HE_THONG', max_length=10, verbose_name='Phân loại cảnh báo')),
                ...
                ('link_xu_ly', models.CharField(blank=True, max_length=255, null=True, verbose_name='Link xử lý')),
                ('nguoi_nhan', models.ForeignKey(limit_choices_to={'is_staff': True}, on_delete=django.db.models.deletion.CASCADE, related_name='cac_thong_bao', to=settings.AUTH_USER_MODEL, verbose_name='Người nhận')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chenh_lech', models.FloatField(default=0, verbose_name='Chênh lệch')),
                ('nguyen_lieu', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='quanly.nguyenlieu')),
