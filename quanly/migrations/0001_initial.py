# Generated by Django 5.2.5 on 2025-08-22 16:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thoi_gian_ket_thuc_thuc_te', models.DateTimeField(blank=True, null=True, verbose_name='Kết thúc thực tế')),
                ('ngay_lam_viec', models.DateField(default=django.utils.timezone.now, verbose_name='Ngày làm việc')),
                ('tien_mat_ban_dau', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Tiền mặt đầu ca')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quanly.menuitem')),
                ('nguyen_lieu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quanly.nguyenlieu')),
            ],
        ),
        migrations.CreateModel(
            name='ChiTietDonHang',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='mon_lien_quan', through='quanly.DinhLuong', to='quanly.nguyenlieu'),
        ),
        migrations.AddField(
            model_name='calamviec',
            name='nhan_vien',
        ...
        migrations.AddField(
            model_name='hoadon',
            name='phien_su_dung',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='hoa_don', to='quanly.phiensudung'),
        ),
        migrations.AddField(
